...
enum {
    ...
    NATIONAL_DEX_ALPACOIL,
    NATIONAL_DEX_ALPACHROME,
    NATIONAL_DEX_LLAMALLOY,
    NATIONAL_DEX_SMACKOP,
    NATIONAL_DEX_STORKICK,
    NATIONAL_DEX_PHORUSMASH,
    NATIONAL_DEX_PUPPIXY,
    NATIONAL_DEX_FAERDILLO,
    NATIONAL_DEX_ARMANOVA,
    //
    NATIONAL_DEX_SKUARCTIC,
    NATIONAL_DEX_SKUINDLE,
    NATIONAL_DEX_ALBURGLE,
    NATIONAL_DEX_DEWSEL,
    NATIONAL_DEX_PUIPOUR,
    NATIONAL_DEX_SEALOCH,
    NATIONAL_DEX_FOWLILY,
    NATIONAL_DEX_FOWLOTUS,
    NATIONAL_DEX_TROPILOT,
    NATIONAL_DEX_PROPIARY,
    NATIONAL_DEX_JETIMBER,
    //
    NATIONAL_DEX_TERMEET,
    NATIONAL_DEX_CLUSTERM,
    NATIONAL_DEX_TERMANATE,
    NATIONAL_DEX_SIGNOLL,
    NATIONAL_DEX_POSSANA,
    NATIONAL_DEX_POSSIERRA,
    NATIONAL_DEX_CLAMOUR,
    NATIONAL_DEX_MUSSCARA,
    NATIONAL_DEX_VALVOGUE,
    //
    NATIONAL_DEX_YUWANA,
    NATIONAL_DEX_GOWANA,
    NATIONAL_DEX_GOWARENTI,
    NATIONAL_DEX_CLAYBARA,
    NATIONAL_DEX_BRICCAPY,
    NATIONAL_DEX_BASILT,
    NATIONAL_DEX_HEXTUFF,
    NATIONAL_DEX_HEXTATURE,
    NATIONAL_DEX_ESCASETE,
    NATIONAL_DEX_RECORGOT,
    NATIONAL_DEX_TROUBULL,
    //
    NATIONAL_DEX_PINNAUGUR,
    NATIONAL_DEX_SHARKELP,
    NATIONAL_DEX_BASKALGAE,
    NATIONAL_DEX_SHYFONO,
    NATIONAL_DEX_EMSIFONO,
    NATIONAL_DEX_SIPHORMIX,
    NATIONAL_DEX_DRILLITO,
    NATIONAL_DEX_DRILLITOIL,
    NATIONAL_DEX_SOLM,
    NATIONAL_DEX_CHASOLM,
    NATIONAL_DEX_GROTTOLM,
    //
    NATIONAL_DEX_GEENKY,
    NATIONAL_DEX_UNFAIREE,
    NATIONAL_DEX_BEETEMOLT,
    NATIONAL_DEX_PHANTOMOLT,
    NATIONAL_DEX_SKIRMUSH,
    NATIONAL_DEX_CORDYSPAR,
    NATIONAL_DEX_ICIRKRILL,
    NATIONAL_DEX_KRILLOWATT,
    NATIONAL_DEX_GRAMAIN,
    NATIONAL_DEX_TARDEVAIL,
    NATIONAL_DEX_SIMIRA,
    NATIONAL_DEX_MIAMIRA,
    NATIONAL_DEX_MIRASTINE,
    NATIONAL_DEX_MIRASKEW,
    NATIONAL_DEX_CANUWAY,
    NATIONAL_DEX_STIKSAIL,
    NATIONAL_DEX_ARAUKEEL,
    //
    NATIONAL_DEX_LURIDIRT,
    NATIONAL_DEX_LURIDWELL,
    NATIONAL_DEX_DESOLONG,
    NATIONAL_DEX_GNOSEPASS,
    NATIONAL_DEX_POCUSPASS,
    //
    NATIONAL_DEX_BEAGLOSS,
    //
    NATIONAL_DEX_UPSITTLE,
    NATIONAL_DEX_UPSUNDER,
    NATIONAL_DEX_PROUDEMIND,
    //
    NATIONAL_DEX_ARTHINGY,
    NATIONAL_DEX_DOOHICRAB,
    //
    NATIONAL_DEX_OHMEOW,
    NATIONAL_DEX_AMPURR,
    NATIONAL_DEX_COMPROAR,
    //
    NATIONAL_DEX_VEILDUCK,
    NATIONAL_DEX_SMOULDRA,
    //
    NATIONAL_DEX_FROSTYLO,
    NATIONAL_DEX_FRACTYLO,
    NATIONAL_DEX_TOTULLY,
    NATIONAL_DEX_MONSTOXIN,
    NATIONAL_DEX_GEKOBOLD,
    NATIONAL_DEX_URDROWSY,
    NATIONAL_DEX_DRACOZY,
    NATIONAL_DEX_MOSSCRUE,
    NATIONAL_DEX_MOSSTRATA,
    NATIONAL_DEX_MOSSTROMA,
    NATIONAL_DEX_TINYMPH,
    NATIONAL_DEX_NYMFOIL,
    NATIONAL_DEX_PHASMETAL,
    NATIONAL_DEX_STRIGILENT,
    NATIONAL_DEX_SOMNILUS,
    NATIONAL_DEX_CHIRURGE,
    //
    NATIONAL_DEX_FORMANDALA
};
...
#define JOHTO_DEX_COUNT     NATIONAL_DEX_CELEBI
    ...
    #define NATIONAL_DEX_COUNT  NATIONAL_DEX_FORMANDALA
...
enum {
    HOENN_DEX_NONE,
    HOENN_DEX_ALPACOIL,
    HOENN_DEX_ALPACHROME,
    HOENN_DEX_LLAMALLOY,
    HOENN_DEX_SMACKOP,
    HOENN_DEX_STORKICK,
    HOENN_DEX_PHORUSMASH,
    HOENN_DEX_PUPPIXY,
    HOENN_DEX_FAERDILLO,
    HOENN_DEX_ARMANOVA,
    //
    ...
    HOENN_DEX_NYMFOIL,
    HOENN_DEX_PHASMETAL,
    HOENN_DEX_STRIGILENT,
    HOENN_DEX_SOMNILUS,
    HOENN_DEX_CHIRURGE,
    //
    HOENN_DEX_FORMANDALA,
};

#define HOENN_DEX_COUNT (HOENN_DEX_FORMANDALA + 1) // CHANGE THIS !!
