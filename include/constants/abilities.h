...
#define ABILITY_AW_START ABILITIES_COUNT_GEN9

#define ABILITY_EXTREMOPHILE    ABILITY_AW_START + 1
#define ABILITY_TONE_DEAF       ABILITY_AW_START + 2
// ...
#define ABILITY_COEVAL          ABILITY_AW_START + 3
#define ABILITY_AMNESIAC        ABILITY_AW_START + 4
#define ABILITY_SLUMBER         ABILITY_AW_START + 5


#define ABILITY_AW_COUNT ABILITY_SLUMBER + 1

#define ABILITIES_COUNT ABILITY_AW_COUNT
