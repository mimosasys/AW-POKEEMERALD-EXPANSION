...
enum {
    ...
    HEAL_LOCATION_AW_VERDIGRIS_CITY,
    HEAL_LOCATION_AW_PORT_MULBERRY,
    HEAL_LOCATION_AW_PUCE_CITY,
    HEAL_LOCATION_AW_ERIN_VILLAGE,
    HEAL_LOCATION_AW_ROUTE108_LOWER,
    HEAL_LOCATION_AW_ROUTE108_LOWER_2,
    HEAL_LOCATION_AW_TOPAZ_LAB,
    NUM_HEAL_LOCATIONS
};
