...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_ALPACOIL = 1573,
    SPECIES_ALPACHROME = 1574,
    SPECIES_LLAMALLOY = 1575,
    SPECIES_SMACKOP = 1576,
    SPECIES_STORKICK = 1577,
    SPECIES_PHORUSMASH = 1578,
    SPECIES_PUPPIXY = 1579,
    SPECIES_FAERDILLO = 1580,
    SPECIES_ARMANOVA = 1581,
    //SPECIES_R1 MAMMAL 1 = 1582,
    //SPECIES_R1 MAMMAL 2 = 1583,
    SPECIES_SKUARCTIC = 1584,
    SPECIES_SKUINDLE = 1585,
    SPECIES_ALBURGLE = 1586,
    SPECIES_DEWSEL = 1587,
    SPECIES_PUIPOUR = 1588,
    SPECIES_SEALOCH = 1589,
    SPECIES_FOWLILY = 1590,
    SPECIES_TROPILOT = 1591,
    SPECIES_PROPIARY = 1592,
    SPECIES_JETIMBER = 1593,
    SPECIES_LENSECT = 1594,
    SPECIES_GRUBARLO = 1595,
    SPECIES_OBUZZERVE = 1596,
    SPECIES_TERMEET = 1597,
    SPECIES_CLUSTERM = 1598,
    SPECIES_TERMANATE = 1599,
    SPECIES_SIGNOLL = 1600,
    SPECIES_POSSANA = 1601,
    SPECIES_POSSIERRA = 1602,
    SPECIES_CLAMOUR = 1603,
    SPECIES_MUSSCARA = 1604,
    SPECIES_VALVOGUE = 1605,
    //SPECIES_CONVERGENT.2 1 = 1606,
    //SPECIES_CONVERGENT.2 2 = 1607,
    //SPECIES_THERO 1 = 1608,
    //SPECIES_THERO 2 = 1609,
    //SPECIES_THERO 3 = 1610,
    SPECIES_CLAYBARA = 1611,
    SPECIES_BRICCAPY = 1612,
    SPECIES_BASILT = 1613,
    SPECIES_HEXTUFF = 1614,
    SPECIES_HEXTATURE = 1615,
    //SPECIES_DIMETRO 1 = 1616,
    SPECIES_IGNICYN = 1617,
    //SPECIES_DIMETRO 3 = 1618,
    SPECIES_ESCASETE = 1619,
    SPECIES_RECORGOT = 1620,
    SPECIES_TROUBULL = 1621,
    //SPECIES_WATER THING.1 1 = 1622,
    //SPECIES_WATER THING.1 2 = 1623,
    SPECIES_PINNAUGUR = 1624,
    SPECIES_SHARKELP = 1625,
    SPECIES_BASKALGAE = 1626,
    SPECIES_SHYFONO = 1627,
    SPECIES_EMSIFONO = 1628,
    SPECIES_SIPHORMIX = 1629,
    SPECIES_DRILLITO = 1630,
    SPECIES_DRILLITOIL = 1631,
    SPECIES_SOLM = 1632,
    SPECIES_CHASOLM = 1633,
    SPECIES_GROTTOLM = 1634,
    SPECIES_ECHORE = 1635,
    SPECIES_RUBITE = 1636,
    SPECIES_VAMPPHIRE = 1637,
    //SPECIES_FAIRY 1 = 1638,
    //SPECIES_FAIRY 2 = 1639,
    SPECIES_BEETEMOLT = 1640,
    SPECIES_PHANTOMOLT = 1641,
    SPECIES_SKIRMUSH = 1642,
    SPECIES_CORDYSPAR = 1643,
    //SPECIES_IGUANADON = 1644
    //SPECIES_??? = 1645,
    SPECIES_ICIRKRILL = 1646,
    SPECIES_KRILLOWATT = 1647,
    SPECIES_GRAMAIN = 1648,
    SPECIES_TARDEVAIL = 1649,
    SPECIES_SIMIRA = 1650,
    SPECIES_MIAMIRA = 1651,
    SPECIES_MIRASTINE = 1652,
    SPECIES_MIRASKEW = 1653,
    SPECIES_CANUWAY = 1654,
    SPECIES_STIKSAIL = 1655,
    SPECIES_ARAUKEEL = 1656,
    //SPECIES_GHOST.2 1 = 1657,
    //SPECIES_GHOST.2 2 = 1658,
    SPECIES_LURIDIRT = 1659,
    SPECIES_LURIDWELL = 1660,
    SPECIES_DESOLONG = 1671,
    SPECIES_GNOSEPASS = 1672,
    SPECIES_POCUSPASS = 1673,
    //SPECIES_FIRE = 1674,
    SPECIES_BEAGLOSS = 1675,
    SPECIES_FAETO = 1676,
    SPECIES_SILFILM = 1677,
    SPECIES_GALLAERY = 1678,
    //SPECIES_??? = 1679,
    //SPECIES_??? = 1680,
    //SPECIES_??? = 1681,
    //SPECIES_FIGHT.2 1 = 1682,
    //SPECIES_FIGHT.2 2 = 1683,
    SPECIES_GIZMIT = 1684,
    SPECIES_CRAWIDGET = 1685,
    //SPECIES_SOLO ELEC 1 = 1686,
    //SPECIES_SOLO ELEC 2 = 1687,
    SPECIES_OHMEOW = 1688,
    SPECIES_AMPURR = 1689,
    SPECIES_COMPROAR = 1690,
    //SPECIES_SOLAR WIND 1 = 1691,
    //SPECIES_SOLAR WIND 2 = 1692,
    //SPECIES_HEALER = 1693,
    SPECIES_PSYDUCK_AW = 1694,
    SPECIES_VEILDUCK = 1695,
    SPECIES_HORSEA_AW = 1696,
    SPECIES_SEADRA_AW = 1697,
    SPECIES_SMOULDRA = 1698,
    SPECIES_FROSTYLO = 1699,
    SPECIES_FRACTYLO = 1700,
    SPECIES_TOTULLY = 1701,
    SPECIES_MONSTOXIN = 1702,
    SPECIES_GEKOBOLD = 1703,
    SPECIES_URDROWSY = 1704,
    SPECIES_DRACOZY = 1705,
    SPECIES_MOSSCRUE = 1706,
    SPECIES_MOSSTRATA = 1707,
    SPECIES_MOSSTROMA = 1708,
    SPECIES_TINYMPH = 1709,
    SPECIES_PHASMESH = 1710,
    SPECIES_PHASMETAL = 1711,
    SPECIES_STRIGILENT = 1712,
    SPECIES_SOMNILUS = 1713,
    SPECIES_CHIRURGE = 1714,
    //SPECIES_TRIO LEGEND 1 = 1715,
    //SPECIES_TRIO LEGEND 2 = 1716,
    //SPECIES_TRIO LEGEND 3 = 1717,
    //SPECIES_DUO LEGEND 1 = 1718,
    //SPECIES_DUO LEGEND 2 = 1719,
    //SPECIES_BYGONE RULER 1 = 1720,
    //SPECIES_BYGONE RULER 2 = 1721,
    //SPECIES_BYGONE RULER 3 = 1722,
    SPECIES_FORMANDALA = 1723,
    //SPECIES_SOLO LEGEND = 1724,
    //SPECIES_SOLO LEGEND = 1725,
    SPECIES_PHASMETAL_M = 1726,
    //SPECIES_BEAGLOSS_FORM 1 = 1727,
    //SPECIES_BEAGLOSS_FORM 2 = 1728,
    SPECIES_FORMANDALA_BATTLE = 1729,
    //SPECIES_BYGONE BUILDER = 1730,
    //SPECIES_BYGONE GATHERER = 1731,
    //SPECIES_BYGONE HARVESTER = 1732,
    SPECIES_AROMATISSE_BYGONE = 1733,
    //SPECIES_BYGONE PHILOSOPHER = 1734,
    SPECIES_DESOLONG_BYGONE = 1735,
    SPECIES_RIBOMBEE_BYGONE = 1736,
    //SPECIES_BYGONE NOMAD = 1737,
    //SPECIES_BYGONE KEEPER = 1738,
    //SPECIES_BYGONE SCRIBE = 1739,
    //SPECIES_BYGONE WARRIOR = 1740,
    //SPECIES_BYGONE ??? = 1741,
    SPECIES_WEAVILE_B = 1742,
