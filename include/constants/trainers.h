...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_AW_P_MALE,
    TRAINER_PIC_AW_P_FEMALE,
    // TRAINER_PIC_AW_P_ENBY,
    TRAINER_PIC_AW_JADEGRUNT_MALE,
    TRAINER_PIC_AW_JADEGRUNT_FEMALE,
    TRAINER_PIC_AW_RIVAL,
    TRAINER_PIC_AW_LEADER_WENDY,
    TRAINER_PIC_AW_LEADER_WYATT,
    TRAINER_PIC_COUNT,
};
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_JADE,
    TRAINER_CLASS_JADE_ADMIN,
    TRAINER_CLASS_JADE_HEAD,
    TRAINER_CLASS_RESEARCHER,
