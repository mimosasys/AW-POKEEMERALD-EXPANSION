...
//const u16 gTitleScreenEmeraldVersionPal[]  = INCBIN_U16("graphics/title_screen/psyche_version.gbapal");
...
//const u32 gTitleScreenEmeraldVersionGfx[]  = INCBIN_U32("graphics/title_screen/psyche_version.8bpp.lz");
