...
const u16 gMetatiles_PuceGym[] = INCBIN_U16("data/tilesets/secondary/puce_gym/metatiles.bin");
const u16 gMetatileAttributes_PuceGym[] = INCBIN_U16("data/tilesets/secondary/puce_gym/metatile_attributes.bin");
#else
