const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_BRENDAN] = TRAINER_PIC_AW_P_MALE,
    [FACILITY_CLASS_BRENDAN_2] = TRAINER_PIC_AW_P_MALE,
    [FACILITY_CLASS_BRENDAN_3] = TRAINER_PIC_AW_P_MALE,
    [FACILITY_CLASS_MAY] = TRAINER_PIC_AW_P_FEMALE,
    [FACILITY_CLASS_MAY_2] = TRAINER_PIC_AW_P_FEMALE,
    [FACILITY_CLASS_MAY_3] = TRAINER_PIC_AW_P_FEMALE,
    ...
    [FACILITY_CLASS_RED] = TRAINER_PIC_AW_P_MALE,
    [FACILITY_CLASS_LEAF] = TRAINER_PIC_AW_P_FEMALE,
    [FACILITY_CLASS_RS_BRENDAN] = TRAINER_PIC_AW_P_MALE,
    [FACILITY_CLASS_RS_MAY] = TRAINER_PIC_AW_P_FEMALE,
    [FACILITY_CLASS_ENBY] = TRAINER_PIC_AW_P_ENBY,
};
