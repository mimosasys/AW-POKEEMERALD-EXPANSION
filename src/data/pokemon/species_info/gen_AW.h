...
// AW POKEMON START HERE
    ...
    [SPECIES_LURIDIRT] = 
    {
        ...
        .abilities = {ABILITY_FOREWARN, ABILITY_STURDY},
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
            "They gather in groups, building small,\n"
            "stone structures to live in. Supposedly,\n"
            "this species is all that's left of a\n"
            "region-spanning civilisation."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LURIDWELL] = 
    {
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
            "They have a distaste for human populations.\n"
            "On some nights, they all drop everything\n"
            "and gather on Mt. Eigo. It is unknown what\n"
            "purpose this serves."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_DESOLONG] = 
    {
        ...
        .weight = 0,
        .description = COMPOUND_STRING(
            "It believes that it is haunted and cursed\n"
            "for something 'it's culture' did many\n"
            "years ago. Perhaps there is a reason it\n"
            "is telling humanity about this?"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
