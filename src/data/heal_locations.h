static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ERIN_VILLAGE - 1] = {MAP_GROUP(ERIN_VILLAGE), MAP_NUM(ERIN_VILLAGE), 23, 59},
    [HEAL_LOCATION_PORT_MULBERRY - 1] = {MAP_GROUP(PORT_MULBERRY), MAP_NUM(PORT_MULBERRY), 12, 13},
    [HEAL_LOCATION_PUCE_CITY - 1] = {MAP_GROUP(PUCE_CITY), MAP_NUM(PUCE_CITY), 10, 10},
};
