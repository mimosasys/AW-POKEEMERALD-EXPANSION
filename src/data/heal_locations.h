static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_AW_ERIN_VILLAGE - 1] = {MAP_GROUP(AW_ERIN_VILLAGE), MAP_NUM(AW_ERIN_VILLAGE), 23, 59},
    [HEAL_LOCATION_AW_PORT_MULBERRY - 1] = {MAP_GROUP(AW_PORT_MULBERRY), MAP_NUM(AW_PORT_MULBERRY), 12, 13},
    [HEAL_LOCATION_AW_PUCE_CITY - 1] = {MAP_GROUP(AW_PUCE_CITY), MAP_NUM(AW_PUCE_CITY), 26, 18},
    [HEAL_LOCATION_AW_ROUTE108 - 1] = {MAP_GROUP(AW_ROUTE108_LOWER), MAP_NUM(AW_ROUTE108_LOWER), 26, 18},
    [HEAL_LOCATION_AW_VERDIGRIS_CITY - 1] = {MAP_GROUP(AW_VERDIGRIS_CITY), MAP_NUM(AW_VERDIGRIS_CITY), 30, 18},
};
