...
{
    HOENN_TO_NATIONAL(ALPACOIL),
    HOENN_TO_NATIONAL(ALPACHROME),
    HOENN_TO_NATIONAL(LLAMALLOY),
    HOENN_TO_NATIONAL(SMACKOP),
    HOENN_TO_NATIONAL(STORKICK),
    HOENN_TO_NATIONAL(PHORUSMASH),
    HOENN_TO_NATIONAL(PUPPIXY),
    ...
    HOENN_TO_NATIONAL(DEWSEL),
    HOENN_TO_NATIONAL(PUIPOUR),
    HOENN_TO_NATIONAL(SEALOCH),
    ...
    HOENN_TO_NATIONAL(SIGNOLL),
    HOENN_TO_NATIONAL(POSSANA),
    HOENN_TO_NATIONAL(POSSIERRA),
    ...
    HOENN_TO_NATIONAL(CLAMOUR),
    HOENN_TO_NATIONAL(MUSSCARA),
    HOENN_TO_NATIONAL(VALVOGUE),
    //
    HOENN_TO_NATIONAL(YUWANA),
    HOENN_TO_NATIONAL(GOWANA),
    HOENN_TO_NATIONAL(GOWARENTI),
    HOENN_TO_NATIONAL(CLAYBARA),
    HOENN_TO_NATIONAL(BRICCAPY),
    HOENN_TO_NATIONAL(BASILT),
    HOENN_TO_NATIONAL(HEXTUFF),
    HOENN_TO_NATIONAL(HEXTATURE),
    //
    HOENN_TO_NATIONAL(ESCASETE),
    HOENN_TO_NATIONAL(RECORGOT),
    ...
    HOENN_TO_NATIONAL(TROUBULL),
    HOENN_TO_NATIONAL(MINIOR),
    HOENN_TO_NATIONAL(SNIVY),
    HOENN_TO_NATIONAL(SERVINE),
    HOENN_TO_NATIONAL(SERPERIOR),
    //
    HOENN_TO_NATIONAL(PINNAUGUR),
    HOENN_TO_NATIONAL(SHARKELP),
    HOENN_TO_NATIONAL(BASKALGAE),
    HOENN_TO_NATIONAL(SHYFONO),
    HOENN_TO_NATIONAL(EMSIFONO),
    HOENN_TO_NATIONAL(SIPHORMIX),
    HOENN_TO_NATIONAL(DRILLITO),
    HOENN_TO_NATIONAL(DRILLITOIL),
    ...
    HOENN_TO_NATIONAL(SOLM),
    HOENN_TO_NATIONAL(CHASOLM),
    HOENN_TO_NATIONAL(GROTTOLM),
    //
    HOENN_TO_NATIONAL(GEENKY),
    HOENN_TO_NATIONAL(UNFAIREE),
    ...
    HOENN_TO_NATIONAL(BEETEMOLT),
    HOENN_TO_NATIONAL(PHANTOMOLT),
    HOENN_TO_NATIONAL(SKIRMUSH),
    HOENN_TO_NATIONAL(CORDYSPAR),
    ...
    HOENN_TO_NATIONAL(ICIRKRILL),
    HOENN_TO_NATIONAL(KRILLOWATT),
    HOENN_TO_NATIONAL(GRAMAIN),
    HOENN_TO_NATIONAL(TARDEVAIL),
    HOENN_TO_NATIONAL(SIMIRA),
    HOENN_TO_NATIONAL(MIAMIRA),
    HOENN_TO_NATIONAL(MIRASTINE),
    HOENN_TO_NATIONAL(MIRASKEW),
    ...
    //
    HOENN_TO_NATIONAL(CANUWAY),
    HOENN_TO_NATIONAL(STIKSAIL),
    HOENN_TO_NATIONAL(ARAUKEEL),
    HOENN_TO_NATIONAL(LURIDIRT),
    HOENN_TO_NATIONAL(LURIDWELL),
    HOENN_TO_NATIONAL(DESOLONG),
    ...
    HOENN_TO_NATIONAL(GNOSEPASS),
    HOENN_TO_NATIONAL(POCUSPASS),
    //
    HOENN_TO_NATIONAL(SMEARGLE),
    HOENN_TO_NATIONAL(BEAGLOSS),
    //
    ...
    HOENN_TO_NATIONAL(UPSITTLE),
    HOENN_TO_NATIONAL(UPSUNDER),
    HOENN_TO_NATIONAL(PROUDEMIND),
    HOENN_TO_NATIONAL(DITTO),
    //
    HOENN_TO_NATIONAL(ARTHINGY),
    HOENN_TO_NATIONAL(DOOHICRAB),
    //
    HOENN_TO_NATIONAL(OHMEOW),
    HOENN_TO_NATIONAL(AMPURR),
    HOENN_TO_NATIONAL(COMPROAR),
    //
    HOENN_TO_NATIONAL(TOXEL),
    HOENN_TO_NATIONAL(TOXTRICITY),
    //
    HOENN_TO_NATIONAL(PSYDUCK),
    HOENN_TO_NATIONAL(VEILDUCK),
    HOENN_TO_NATIONAL(HORSEA),
    HOENN_TO_NATIONAL(SEADRA),
    HOENN_TO_NATIONAL(SMOULDRA),
    HOENN_TO_NATIONAL(PORYGON),
    HOENN_TO_NATIONAL(PORYGON2),
    HOENN_TO_NATIONAL(PORYGON_Z),
    HOENN_TO_NATIONAL(SIGILYPH),
    //
    HOENN_TO_NATIONAL(FROSTYLO),
    HOENN_TO_NATIONAL(FRACTYLO),
    HOENN_TO_NATIONAL(TOTULLY),
    HOENN_TO_NATIONAL(MONSTOXIN),
    HOENN_TO_NATIONAL(GEKOBOLD),
    HOENN_TO_NATIONAL(URDROWSY),
    HOENN_TO_NATIONAL(DRACOZY),
    ...
    HOENN_TO_NATIONAL(MOSSCRUE),
    HOENN_TO_NATIONAL(MOSSTRATA),
    HOENN_TO_NATIONAL(MOSSTROMA),
    HOENN_TO_NATIONAL(TINYMPH),
    HOENN_TO_NATIONAL(NYMFOIL),
    HOENN_TO_NATIONAL(PHASMETAL),
    HOENN_TO_NATIONAL(STRIGILENT),
    HOENN_TO_NATIONAL(SOMNILUS),
    HOENN_TO_NATIONAL(CHIRURGE),
    //
    HOENN_TO_NATIONAL(FORMANDALA),
};
...
u16 PlayerGenderToFrontTrainerPicId(u8 playerGender)
{
    if (playerGender == MALE)
        return TRAINER_PIC_AW_P_MALE;
    else if (playerGender == FEMALE)
        return TRAINER_PIC_AW_P_FEMALE;
    else
        return TRAINER_PIC_AW_P_ENBY;
}
