...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(LEADER, "Gym Leader", 25),
    ...
    TRAINER_CLASS(COOLTRAINER_2, "Cool Trainer", 5, ITEM_ULTRA_BALL),
    ...
    TRAINER_CLASS(YOUNG_COUPLE, "Youn Couple", 8),
    ...
    TRAINER_CLASS(JADE, "Jade Grunt"),
    TRAINER_CLASS(JADE_ADMIN, "Jade Admin"),
    TRAINER_CLASS(JADE_HEAD, "Jade Head"),
    TRAINER_CLASS(RESEARCHER, "Researcher")
};
