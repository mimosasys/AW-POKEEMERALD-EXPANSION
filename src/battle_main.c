...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_RICH_BOY] = { _("Rich Kid"), 50 },
    ...
    [TRAINER_CLASS_BUG_CATCHER] = { _("Byg Catcher"), 4 },
    ...
    [TRAINER_CLASS_SIS_AND_BRO] = { _("Siblings"), 3 },
    ...
    [TRAINER_CLASS_JADE] = { _("Team Jade") },
    [TRAINER_CLASS_JADE_ADMIN] = { _("Jade Admin") },
    [TRAINER_CLASS_JADE_HEAD] = { _("Jade Prof.") },
